                    ...
                    <div class="product-item-label-text">
                        ...
                        if ($item['PROPERTIES']['LABEL_REF']['VALUE']) {
                            ...
                            foreach ($item['PROPERTIES']['LABEL_REF']['VALUE'] as $label) {
                                ...
                                ?>
                                <span style="position: sticky; border-radius: 25px;
                                        background: rgb(<?= $arParams['HLB_LABELS'][$label]['UF_COLOR_RGB'] ?>);">
					                        <a href="<?= $arParams['UF_LINK'][$label]['UF_LINK'] ?>"
                                            style="color: #000000"><?= $arParams['HLB_LABELS'][$label]['UF_NAME'] ?></a>
			                    </span>
                                <?
                                $countLabel++;
                            }
